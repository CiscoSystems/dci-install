...
virt-customize -v -x --selinux-relabel -a overcloud-full.qcow2 --copy-in /home/stack/images/config.py:/usr/lib/python2.7/site-packages/networking_cisco/plugins/ml2/drivers/cisco/ucsm/
